...
router.post(
  "/list",
  validateResource(listRewardsSchema),
...
router.post(
  "/single",
  validateResource(singleRewardSchema),
...
router.post(
  "/by-tier",
  validateResource(tierRewardsSchema),
  rewardController.getByTierId
);
...
router.post(
  "/restore",
  validateResource(singleRewardSchema),
  rewardController.restore
);
router.post(
  "/hard-delete",
  validateResource(singleRewardSchema),
  rewardController.hardDelete
);
router.post(
  "/toggle-status",
  validateResource(singleRewardSchema),
  rewardController.toggleStatus
);
router.post(
  "/stats",
  validateResource(singleRewardSchema),
